...
// 22 usable chars + NUL. Keeps the probe-config region under the 256-byte
// EEPROM offset ceiling (4 probes from offset 64 end at byte 252).
#define PROBE_NAME_SIZE 23
